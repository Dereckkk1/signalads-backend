...
// ─────────────────────────────────────────────────────────────
// NOTA: o auto-block automático por IP (heurística de bot por taxa de
// 404s / diversidade de rotas) foi DESCONTINUADO. Gerava 403 em usuários
// legítimos não autenticados navegando o marketplace e, atrás de NAT/CGNAT/
// proxy, derrubava o IP inteiro (vários usuários de uma vez). O bloqueio por
// IP agora é apenas MANUAL (admin via /api/admin/monitoring/block-ip).
// O enforcement (checkBlockedIP) e o bloqueio por conta (User.status) seguem.
// ─────────────────────────────────────────────────────────────
